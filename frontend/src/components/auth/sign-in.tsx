...
const SignIn = () => {
  return (
    <Card className="w-[350px] max-h-[500px] rounded-2xl shadow-xl mt-5">
      <CardContent className=" px-4 py-2 sm:px-6 sm:py-3">
        ...
        <div className="text-right mb-6">
          <button className="text-sm text-gray-400 hover:text-blue-500">
            Forgot password?
          </button>
        </div>

        {/* Button */}
        <Button className="w-full rounded-full text-md py-6 bg-gradient-to-r from-blue-400 to-indigo-500 hover:opacity-90 my-4">
          Sign in
        </Button>
